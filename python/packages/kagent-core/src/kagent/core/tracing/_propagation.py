...
With httpx client auto-instrumentation disabled by default (ISI-1736) to cut
...
across the memory hop. It is the same remedy ISI-1739 applied to A2A sub-agent
calls in ``_remote_a2a_tool.py``, factored out so it can be attached to any
httpx client. See ISI-1739 for the A2A side of this regression.
"""
